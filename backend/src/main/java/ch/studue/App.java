...
public final class App {
    ...
    public static void main(String[] args) throws IOException {
        ...
        SessionService sessionService = new SessionService(config.sessionTtlSeconds());
        ...
        server.createContext("/api/auth", new AuthHandler(config, sessionService, authorizationService));
